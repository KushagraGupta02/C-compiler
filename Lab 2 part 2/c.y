...
primary_expression
	: IDENTIFIER { $1 = new ASTNode(yylval.str); $$= new ASTNode("Identifer",$1);}
	| constant { $$= $1;}
	| string { $$= $1;}
	| '(' expression ')' { $$= $2;}
	| generic_selection { $$= $1;}
...
constant
	: I_CONSTANT		{ $1 = new ASTNode(yylval.str);$$= $1;}/* includes character_constant */
	| F_CONSTANT    { $1 = new ASTNode(yylval.str);$$= $1;}
	| ENUMERATION_CONSTANT	 { $1 = new ASTNode(yylval.str);$$= $1;} /* after it has been defined as such */
	;

enumeration_constant		/* before it has been defined as such */
	: IDENTIFIER { $1 = new ASTNode(yylval.str); $$= new ASTNode("enumeration_constant", $1); }
	;

string
	: STRING_LITERAL { $1 = new ASTNode(yylval.str);$$= $1;}
	| FUNC_NAME { $1 = new ASTNode(yylval.str);$$= $1;}
	;
